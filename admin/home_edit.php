        ...
        <!---------------------- NAVBAR Modification -------------------------------->
            ...
            <div class="container-fluid">
                ...
                <div class="container text-center">
                    <h2 style="font-family: Times New Roman, Times, serif" class="text-center pt-3 pb-3"> Home Page </h2>
                    <div class="row">
                        <!------------------------- FORM ------------------------------------------------------------------>
                                    ...
                                    <div class="card shadow-lg bg-light">
                                        <div class="card-body">
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                <div class="row">
                                                    <h4 style="font-family: Times New Roman, Times, serif" class="text-center pt-1 pb-1">Hospital Image</h4>
                                                    ...
                                                    if (isset($_POST['upload'])) {
                                                        ...
                                                        $sql = "UPDATE display SET filename = '$filename' WHERE id = 6";
                                            ...
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST['insert'])){
                                                    ...
                                                    if($headerb == "true" && $paragraphb == "true"){
                                                        $sql = "UPDATE display SET title = '$header', description = '$paragraph' WHERE id = 6";
                                                        // Execute query
                                                        mysqli_query($conn, $sql);
                                                    }
                                                }  
