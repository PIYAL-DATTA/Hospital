        ...
        <!---------------------- NAVBAR Modification -------------------------------->
            ...
            <div class="container-fluid">
                ...
                <div class="container text-center">
                    <h2 style="font-family: Times New Roman, Times, serif" class="text-center pt-3 pb-3"> Doctors Portfolio </h2>
                    <div class="row">
                        <!------------------------- FORM ------------------------------------------------------------------>
                                    ...
                                    <div class="card shadow-lg bg-light">
                                        <div class="card-body">
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                <!------------------------------- Nav Item ---------------------------------------->
                                                <h4 style="font-family: Times New Roman, Times, serif" class="text-center pt-1 pb-1">Doctor</h4>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 pb-3">
                                                        <input type="text" class="form-control" placeholder="Enter small description about Doctor" name="paragraph">
                                                        <span><?php echo $paragraphErr; ?></span>
                                                    </div>
                                                    <div class="col-md-12 pb-3">
                                                        <input type="text" class="form-control"  placeholder="Enter Portfolio link..." name="link" value="">
                                                    ...
                                                    <?php //====== PHP CODE ===============================>
                                                        if (isset($_POST['insert'])){
                                                            ...
                                                            if($headerb == "true" && $paragraphb == "true" && $linkb == "true" && $imgb == "true"){ //
                                                                ...
                                                                $stmt = $conn->prepare("INSERT INTO doctorlist (name, description, link, filename) VALUES (?, ?, ?, ?)");
                            ...
                            <div class="pb-2">
                                <div class="card shadow-lg bg-light">
                                    <div class="card-body">
                                        <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                            <div class="row">
                                                <h4 style="font-family: Times New Roman, Times, serif" class="text-center pt-1 pb-1">Remove Doctor</h4>
                                                <div class="row">
                                                    <div class="col-md-10 pb-2">
                                                        <input type="text" class="form-control"  placeholder="Enter doctor name" name="d_name">
