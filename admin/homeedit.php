            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container text-center">
                        <h2 style="font-family: Times New Roman, Times, serif" class="text-center pt-3 pb-3"> Home </h2>
                        <div class="row">
                            <!------------------------- FORM ------------------------------------------------------------------>
                            <div class="col-xl-6">
                                <div class="pb-2">
                                    <div class="card shadow-lg bg-light">
                                        <div class="card-body">
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <h4 style="font-family: Times New Roman, Times, serif" class="text-center pt-1 pb-1">Home Image</h4>
                                                    <div class="col-md-9">
                                                    ...
                                                    if (isset($_POST['upload'])) {
                                                        ...
                                                        $folder = "./homeimg/".$filename;
                                                        //Setting file new destination
                                                        // Get all the submitted data from the form
                                                        $sql = "UPDATE homeimg SET filename = '$filename' WHERE id = 1";
                                        ...
                                        <div class="card-body">
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST['insert'])){
                                                    ...
                                                    if($headerb == "true" && $paragraphb == "true"){
                                                        $sql = "UPDATE home SET header = '$header', paragraph = '$paragraph' WHERE id = 1";
                                                        // Execute query
                                                        mysqli_query($conn, $sql);
                                                    }
                                                }  
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        if (isset($_POST['navinsert'])){
                                                            ...
                                                            if(empty($navitem) && empty($link)) {
                                                                ...
                                                                if ($use != "true") {
                                                                    $stmt = $conn->prepare("INSERT INTO navitem (navitem, link) VALUES (?, ?)");
                                            ...
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    if (isset($_POST['logoupload'])) {
                                                        ...
                                                        //Setting file new destination
                                                        // Get all the submitted data from the form
                                                        $sql = "UPDATE navimg SET filename = '$filename' WHERE id = 1";
                                                        ...
                                                        if (isset($_POST['delete'])) {
                                                            if(empty($_POST["d_navitem"])) {
                                                                ...
                                                                $d_navitem = $_POST["d_navitem"];
                                                                    ...
                                                                    $sql = "DELETE FROM navitem WHERE navitem = ?";
                                                                    $stmt = $conn->prepare($sql);
