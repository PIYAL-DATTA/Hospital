        ...
        <!---------------------- NAVBAR Modification -------------------------------->
            ...
            <div class="container-fluid">
                ...
                <div class="container text-center">
                    <h2 style="font-family: Times New Roman, Times, serif" class="text-center pt-3 pb-3">Services</h2>
                    <div class="row">
                        <!------------------------- FORM ------------------------------------------------------------------>
                                            ...
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    if (isset($_POST['upload'])) {
                                                        ...
                                                        $sql = "UPDATE display SET filename = '$filename' WHERE id = 8";
                                            ...
                                            <form method = "post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST['insert'])){
                                                    ...
                                                    if($headerb == "true" && $paragraphb == "true"){
                                                        $sql = "UPDATE display SET title = '$header', description = '$paragraph' WHERE id = 8";
                                                        // Execute query
                                                        mysqli_query($conn, $sql);
                                                    }
                                                }  
